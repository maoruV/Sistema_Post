...
- **IVA 19%** configurable por venta (toggle aplicar/no aplicar)
...
- **Test suite** 49 pruebas automatizadas en 5 apps
...
- **Testing:** Django TestCase, 49 tests en accounts, inventory, clients, suppliers, sales
...
..\.venv\Scripts\python.exe manage.py test apps.inventory
..\.venv\Scripts\python.exe manage.py test apps.clients
..\.venv\Scripts\python.exe manage.py test apps.suppliers
...
| App       | Tests | Cubre |
|-----------|-------|-------|
| accounts  | 17    | Modelos (roles, permisos), autenticación, acceso por rol, reseteo de contraseña |
| inventory | 9     | Categorías, productos, stock mínimo |
| clients   | 3     | Creación de clientes, campos opcionales |
| suppliers | 6     | Proveedores, facturas, estados de factura |
| sales     | 14    | Folios, IVA al 19%, flujo completo de venta, stock, cancelación, permisos |
| **Total** | **49** | |
